...
while (True):
    ...
    upper_orange = np.array([15, 230, 230])
    objmask_orange = cv2.inRange(hsv, lower_orange, upper_orange)

    lower_purple = np.array([120,50,20])
    upper_purple = np.array([150,180,70])
    objmask_purple = cv2.inRange(hsv, lower_purple, upper_purple)

    lower_green = np.array([55,20,50])
    upper_green = np.array([80,170,120])
    objmask_green = cv2.inRange(hsv, lower_green, upper_green)

    objmask = objmask_orange + objmask_purple + objmask_green
